...
const NON_INTERACTIVE_CLIENT_SECRET = 'vAVzTJme-GS0Dzz_yAcDenTr_XYeTBFcp3LYmBkLQ6SwghOU5ddodEMYDDXV39bS';
...
app.listen(3000, function () {
    console.log('Express Server Web App listening on port 3000');
});